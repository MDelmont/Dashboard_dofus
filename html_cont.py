...
class Html_content():
    ...
    def make_form_value(self,value):
        try:
    ...
    def make_html_card_item(self,
                            name='Amulette de la shokkot',
                            Niveau='200',
            ...
            return html.Div(
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        children=[
                            html.P(
                                f'{self.make_form_value(value)} {self.make_form_key(key)}',
                                className='Effet-text green',
                            ) 
                            
                            if self.extract_value(value) > 0   else 
